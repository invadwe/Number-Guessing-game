...
entry_field = tk.Entry(layout2, font=("Arial", 16), bg='#edf7f6', textvariable=guessed_number, validate="key", validatecommand=(validate_input_cmd, "%P"), justify="center")
entry_field.pack(side='top', fill='both', expand=True)

check_button = tk.Button(layout2, text="Check", font=("Arial", 16), bg='#fccb06', state='disabled', activebackground='#edf7f6', command=play_game)
